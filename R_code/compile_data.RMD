...
#### Trips ####
data.all$trips <- rbind(data.2014$trips, data.2018$trips, data.2022$trips, data.2023$trips)
#nrow(data.all$trips)
...
data.all$fish <- rbind(data.2014$fish, data.2018$fish, data.2022$fish, data.2023$fish)
data.all$fish <- data.all$fish[data.all$fish$loc_id != "2017_042_08",]

#### Abundance ####
data.all$abundance <- rbind(data.2014$abundance, data.2018$abundance, data.2022$abundance, data.2023$abundance)
