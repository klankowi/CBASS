...
plot.herring <- egg::ggarrange(t1, t2, t3, t4, t5, t6, nrow=3, ncol=2,
...
ggsave(plot = plot.silver,
       filename = here('Documentation/MEPS/Figures/Silverside GAM.png'),
       width = 338, 
       height = 169,
       units = 'mm')

ggsave(plot = plot.herring,
       filename = here('Documentation/MEPS/Figures/Herring GAM.png'),
       width = 338, 
       height = 245,
       units = 'mm')
